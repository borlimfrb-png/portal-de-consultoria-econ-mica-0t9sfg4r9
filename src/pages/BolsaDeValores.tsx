...
export default function BolsaDeValores() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F0F4F8]">
      {/* 1. HERO INSTITUCIONAL (Fintech Global Markets Terminal) */}
      <section className="bg-[#082852] text-white py-14 sm:py-20 border-b border-[#0B3B7A] relative overflow-hidden">
        ...
        <div className="absolute -top-24 -right-24 w-[450px] h-[450px] bg-[#16A34A]/25 rounded-full blur-3xl pointer-events-none animate-float-slow-1" />
        <div className="absolute -bottom-24 -left-24 w-[450px] h-[450px] bg-[#1557A6]/35 rounded-full blur-3xl pointer-events-none animate-float-slow-2" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
          {indices.map((item) => {
            ...
            return (
              <div
                key={item.symbol}
                className="bg-white rounded-2xl p-5 border border-stone-200/90 hover:border-[#16A34A] card-hover-lift transition-all shadow-xs hover:shadow-lg flex flex-col justify-between relative overflow-hidden group"
              >
