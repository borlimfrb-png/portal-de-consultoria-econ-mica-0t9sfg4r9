...
export default function NotFound() {
  return (
    <div className="min-h-[70vh] flex items-center justify-center bg-[#F0F4F8] px-4 py-20">
      <div className="max-w-md w-full text-center space-y-6 bg-white p-8 sm:p-10 rounded-2xl border border-stone-200/90 shadow-sm">
        ...
        <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <Link
            to="/indicadores"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-[#F0F4F8] border border-stone-300 hover:border-[#16A34A] text-[#082852] text-xs font-mono font-bold uppercase tracking-wider rounded-lg transition-colors"
          >
