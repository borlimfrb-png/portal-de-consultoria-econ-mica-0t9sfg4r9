...
export default function Sobre() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F0F4F8]">
      {/* 1. Header Hero (Fintech Institutional Architecture) */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a
                href="#valuation"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-gradient-to-r from-[#16A34A] to-[#15803D] hover:from-[#15803D] hover:to-[#166534] text-white text-xs sm:text-sm font-mono font-bold uppercase tracking-wider transition-all shadow-md hover:shadow-xl border border-[#22C55E]/40"
              >
